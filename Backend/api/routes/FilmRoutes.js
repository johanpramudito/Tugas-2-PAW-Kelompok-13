...
const { getFilms } = require("../controllers/getController");
...
FilmRouter.get("/", getFilms);                   // GET /film (supports sorting with query ?sort=asc or ?sort=desc) contoh GET /films?sort=asc
